...
function get_result_exam(id, path) {
    ...
    if (tm.querySelector("a") == null) {
        ...
        if (tm2[tm2.length - 1].textContent.trim() == "") {
            ...
            window.location.href = tm.querySelector("a").href;
        }
    }
    ...
    while (true) {
        dom = window.document.querySelector(".btn.btn-info.btn-show-comment");
        if (dom == null) {
            break;
        }
        dom.click();
    ...
    try {
        window.document.querySelector(".wrap-title-page").remove();
    } catch (e) {}
    try {
    ...
    while (true) {
        try {
            window.document.querySelector(".btn").remove();
        } catch (e) {
            break;
        }
    }
    ...
    while (true) {
        try {
            window.document.querySelector(".main-content.bg-paper-w.full-exam-list .main-content>input").remove();
        } catch (e) {
            break;
        }
    }
    while (true) {
        try {
            window.document.querySelector(".main-content.bg-paper-w.full-exam-list .main-content>a").remove();
        } catch (e) {
            break;
        }
    }
    ...
    cau = window.document.querySelectorAll(".main-content.bg-paper-w.full-exam-list .main-content>.tab-pane");
    ...
    while (true) {
        ...
        while (dom_capture.offsetHeight > max_height) {
            cau[end - 1].style.display = "none";
            loi_giai[end - 1].style.display = "none";
            end--;
        ...
        iimPlayCode(
            ...
            'TAG POS=1 TYPE=MAIN ATTR=CLASS:main-content CONTENT=EVENT:SAVE_ELEMENT_SCREENSHOT'
        );
        ...
        for (let i = end; i < cau.length; i++) {
            cau[i].style.display = "";
            loi_giai[i].style.display = "";
        }
        start = end;
        for (let i = start - 1; i >= 0; i--) {
            cau[i].style.display = "none";
            loi_giai[i].style.display = "none";
        }
    }
